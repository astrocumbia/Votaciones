					...
					<div class="col-md-8" style="margin-top: 8%;">
						<div class="row margencontendorcentral">
							<div class="form-group text-center">
								...
								<input type="text" name="claveelector" required="required" class="form-control input-lg text-center" pattern="*[A-Z0-9]{18}" minlength="18" maxlength="18" style="text-transform:uppercase">
